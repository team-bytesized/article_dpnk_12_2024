...
class SysInfo(object):
    def __init__(A):
        A.net_info = Position().net_info()
        A.sys_info = HostInfo().sysinfo()
...
def ups(sn):
    try:
        ...
        if os.path.basename(sn) != "flist":
            write_flist(
                up_time + "_" + os.path.basename(sn) + " : " + sn + "\n"
            )
    except:
        pass
